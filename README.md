...
## Added - Contents
This is the entirety of the C++ scripts used on the World of Warcraft private server, Ascension. The term Awakening is the predecessor of Ascension. The last date of this repository is March 29th, 2017.

None of these commit entries were edited.

Ascension is currently using TrinityCore - a product listed under the GPL 2.0 License, also known as the GENERAL PUBLIC USE LICENSE, which restricts them from monetizing or privatizing this content.
