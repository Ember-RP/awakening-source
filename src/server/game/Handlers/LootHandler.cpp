...
void WorldSession::HandleAutostoreLootItemOpcode(WorldPacket& recvData)
{
    ...
    else
    {
        ...
        bool lootAllowed = creature && creature->IsAlive() == (player->getClass() == CLASS_DRUID && creature->loot.loot_type == LOOT_PICKPOCKETING); //Awakening Rogue to Druid
...
void WorldSession::HandleLootMoneyOpcode(WorldPacket& /*recvData*/)
{
    ...
    switch (guid.GetHigh())
    {
        ...
        case HighGuid::Vehicle:
        {
            ...
            bool lootAllowed = creature && creature->IsAlive() == (player->getClass() == CLASS_DRUID && creature->loot.loot_type == LOOT_PICKPOCKETING); //Awake Rogue to Druid 
...
void WorldSession::DoLootRelease(ObjectGuid lguid)
{
    ...
    else
    {
        ...
        bool lootAllowed = creature && creature->IsAlive() == (player->getClass() == CLASS_DRUID && creature->loot.loot_type == LOOT_PICKPOCKETING); //Awake 
        if (!lootAllowed || !creature->IsWithinDistInMap(_player, INTERACTION_DISTANCE))
            return;
