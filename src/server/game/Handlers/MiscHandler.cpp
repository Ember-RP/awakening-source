...
void WorldSession::HandleWhoOpcode(WorldPacket& recvData)
{
   ...
   */
	...
	*/
	...
	data.put(4, matchcount > 50 ? (matchcount + sWorld->getIntConfig(CONFIG_WHO_COUNT) * sWorld->getIntConfig(CONFIG_WHO_COUNT_MULTIPLIER)) : (matchcount + sWorld->getIntConfig(CONFIG_WHO_COUNT) * sWorld->getIntConfig(CONFIG_WHO_COUNT_MULTIPLIER)));        // insert right count, online count
