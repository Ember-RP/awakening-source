...
bool Guardian::UpdateStats(Stats stat)
{
    ...
    else if (stat == STAT_STAMINA)
    {
        if ((GetEntry() == ENTRY_IMP || 
			GetEntry() == ENTRY_VOIDWALKER ||
			GetEntry() == ENTRY_SUCCUBUS ||
			GetEntry() == ENTRY_FELHUNTER ||
			GetEntry() == ENTRY_FELGUARD) && IsPet())
        {
    ...
    else if (stat == STAT_INTELLECT)
    {
        if (((GetEntry() == ENTRY_IMP ||
			...
			GetEntry() == ENTRY_SUCCUBUS ||
			GetEntry() == ENTRY_FELHUNTER ||
			GetEntry() == ENTRY_FELGUARD) && IsPet()) || ((GetEntry() == ENTRY_WATER_ELEMENTAL || GetEntry() == ENTRY_FIRE_ELEMENTAL) && IsPet()))
        {
