...
enum ArmorSubClass
{
    ARMOR_SUBCLASS_CLOTH = 0,
    ARMOR_SUBCLASS_LEATHER,
    ARMOR_SUBCLASS_MAIL,
    ARMOR_SUBCLASS_PLATE,
    ARMOR_SUBCLASS_SHIELD,
    ARMOR_SUBCLASS_END
};
...
class TC_GAME_API Unit : public WorldObject
{
    public:
        ...
        typedef boost::container::flat_map<uint8, AuraApplication*> VisibleAuraMap;
    ...
    protected:
        ...
        uint32 m_armorSubClass[ARMOR_SUBCLASS_END]; // Awake
