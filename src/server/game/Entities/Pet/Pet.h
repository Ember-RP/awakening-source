...
class TC_GAME_API Pet : public Guardian
{
    public:
        ...
        */
		...
		uint32 GetSummonedBySpellId() const { return m_summonedBySpellId; }
		void SetSummonedBySpellId(uint32 spellId) { m_summonedBySpellId = spellId; }
