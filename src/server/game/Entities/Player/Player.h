...
class TC_GAME_API Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        Pet* GetPet() const;
		Pet* SummonPet(uint32 entry, float x, float y, float z, float ang, PetType petType, uint32 despwtime, uint32 summonedBySpellId);
		...
		//AWAKENING:
  		void _RecalculateBaseArmor(uint8 pSlot = 23, bool apply = false);
		...
		/***                 TRANSMOG SYSTEMS                  ***/
		/*********************************************************/
		bool _canSeeTransmog;
		bool CanSeeTransmog() const { return _canSeeTransmog; }
