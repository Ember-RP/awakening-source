...
ElunaRegister<Object> ObjectMethods[] =
{
	...
	{ "HasByteFlag", &LuaObject::HasByteFlag },
...
#if (!defined(TBC) && !defined(CLASSIC))
	{ "GetSanctuary", &LuaUnit::GetSanctuary },
#endif
#if (!defined(TBC) && !defined(CLASSIC))
...
ElunaRegister<Player> PlayerMethods[] =
{
	...
	//AWAKENING:
	{ "GetSpellCost", &LuaPlayer::GetSpellCost },
	{ "GetSpellCooldown", &LuaPlayer::GetSpellCooldown },
	{ "GetSpellRange", &LuaPlayer::GetSpellRange },
	{ "GetSpellPowerType", &LuaPlayer::GetSpellPowerType },
	{ "GetSpellCastTime", &LuaPlayer::GetSpellCastTime},
	...
	{ "ModifyPower", &LuaPlayer::ModifyPower },
...
ElunaRegister<Item> ItemMethods[] =
{
	...
	{ "GetEnchantmentSpellId", &LuaItem::GetEnchantmentSpellId },
