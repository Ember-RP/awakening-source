...
public:
	...
	void OnCreateItem(Player* pPlayer, Item* pItem);
	void OnSpellStart(Player* pPlayer, Spell* spell);
    /* Item */
    ...
    void OnBGEnd(BattleGround* bg, BattleGroundTypeId bgId, uint32 instanceId, uint32 winner);
