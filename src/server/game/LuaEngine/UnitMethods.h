...
namespace LuaUnit
{
	...
	/**
	* Returns true if the [Unit] flagged for FFAPvP.
	*
    ...
    */
	...
	int GetSanctuary(lua_State* L, Unit* unit)
    {
        Eluna::Push(L, unit->HasByteFlag(UNIT_FIELD_BYTES_2, 1, UNIT_BYTE2_FLAG_SANCTUARY));
        return 1;
	}
