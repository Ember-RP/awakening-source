...
namespace LuaItem
{
	...
	/*
	*Returns the SpellId of the enchantment ID.
	*/
	int GetEnchantmentSpellId(lua_State* L, Item* item)
	{
		uint32 enchant_slot = Eluna::CHECKVAL<uint32>(L, 2);
		...
		Eluna::Push(L, item->GetEnchantmentSpellId(EnchantmentSlot(enchant_slot)));
		return 1;
	}
