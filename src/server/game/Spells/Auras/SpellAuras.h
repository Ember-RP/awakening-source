...
class TC_GAME_API Aura
{
    ...
    public:
	    // r00tz: switching to unordered_map improves performance
		...
		bool isOwnerUpdated() const 
		{
			return m_ownerUpdated;
		}

		void setOwnerUpdated(bool value) 
		{
			m_ownerUpdated = value;
		}
