...
uint32 SpellHistory::CalcCooldown(SpellInfo const* spellInfo, Spell* spell)
{
	...
	GetCooldownDurations(spellInfo, 0, &cooldown, &categoryId, &categoryCooldown);
