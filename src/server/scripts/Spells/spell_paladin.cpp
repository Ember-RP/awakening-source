    ...
    public:
        ...
        class spell_pal_holy_shock_SpellScript : public SpellScript
        {
			...
			void HandleDamage()
			{
				...
				int32 damageMod = damage * 0.15;
				int32 finalDmg = damage - damageMod;

				GetCaster()->CastCustomSpell(GetCaster(), SPELL_PALADIN_HOLY_SHOCK_R1_DAMAGE, &finalDmg, nullptr, nullptr, true);
			}
            ...
            void Register() override
            {
				...
				OnHit += SpellHitFn(spell_pal_holy_shock_SpellScript::HandleDamage);
            }
        };
