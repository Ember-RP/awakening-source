            ...
            void HandleScriptEffect(SpellEffIndex effIndex)
            {
                ...
                switch (effIndex)
                {
                    ...
                    case EFFECT_1: // On damaging spells, for removing a defend layer
                    {
                        ...
                        {
                            if (Aura* aura = kvPair.second->GetBase())
                            {
...
enum Mounts
{
    ...
    // Seabiscuit mount
    SPELL_SEABISCUIT_60        = 966003,
    SPELL_SEABISCUIT_100        = 966004
};
    ...
    public:
        ...
        class spell_gen_pet_summoned_SpellScript : public SpellScript
        {
            ...
            void HandleScript(SpellEffIndex /*effIndex*/)
            {
                ...
                {
                    PetType newPetType = (player->getClass() == CLASS_DRUID) ? HUNTER_PET : SUMMON_PET; // Awake
        ...
        class spell_gen_gm_freeze_AuraScript : public AuraScript
        {
            ...
            void OnApply(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
            {
                ...
                if (Player* player = GetTarget()->ToPlayer())
                {
                    ...
                    // if player class = hunter || warlock || druid remove pet if alive
                    if ((player->getClass() == CLASS_HUNTER) || (player->getClass() == CLASS_WARLOCK) || (player->getClass() == CLASS_DRUID)) // Awake
                    {
...
void AddSC_generic_spell_scripts()
{
    ...
    new spell_gen_mount("spell_seabiscuit", 0, SPELL_SEABISCUIT_60, SPELL_SEABISCUIT_100);
}
